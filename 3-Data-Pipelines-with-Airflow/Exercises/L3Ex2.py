...
create_young_task = PostgresOperator(
    task_id="create_young",
    dag=dag,
    sql="""
        BEGIN;
...
create_bike_freq_task = PostgresOperator(
    task_id="bike_freq",
    dag=dag,
    sql="""
        BEGIN;
...
create_city_station_count_task = PostgresOperator(
...
log_young_task = PythonOperator(
    task_id="log_young",
    dag=dag,
    python_callable=log_young
)

create_oldest_task >> log_oldest_task
create_young_task >> log_young_task
